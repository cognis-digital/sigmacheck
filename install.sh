#!/usr/bin/env sh
# Universal installer for sigmacheck. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sigmacheck.git"
echo "Installing sigmacheck ..."
