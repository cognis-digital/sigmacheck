"""Native cognis-connect emit for sigmacheck — forward findings to any platform.

Maps sigmacheck's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    sigmacheck ... --format json | sigmacheck-emit --to stix
    sigmacheck-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
