"""SIGMACHECK core — Lint and unit-test Sigma detection rules against sample events."""
...
RULES = [
    ("SIG-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SIG-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SIG-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
